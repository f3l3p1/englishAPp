...
/* harmony import */ var _overlays_2ea57630_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./overlays-2ea57630.js */ 1173);
/* harmony import */ var _theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./theme-01f3f29c.js */ 1882);
/* harmony import */ var _index_8579e7fd_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./index-8579e7fd.js */ 2376);
/* harmony import */ var _ionic_global_8f9440ec_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./ionic-global-8f9440ec.js */ 1298);
...
/* harmony import */ var _hardware_back_button_8e2c1354_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./hardware-back-button-8e2c1354.js */ 1119);
...
const handleCanDismiss = /*#__PURE__*/function () {
  var _ref2 = (0,_Users_user_Documents_Workspace_englishApp_englishAppFrontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el, animation) {
    /**
     ...
     */
    const shouldDismiss = yield el.canDismiss(undefined, _overlays_2ea57630_js__WEBPACK_IMPORTED_MODULE_8__.G);
    if (!shouldDismiss) {
      return;
    }
    /**
...
const createSwipeToCloseGesture = (el, animation, statusBarStyle, onDismiss) => {
  ...
  const gesture = (0,_index_39782642_js__WEBPACK_IMPORTED_MODULE_15__.createGesture)({
    ...
    gesturePriority: _overlays_2ea57630_js__WEBPACK_IMPORTED_MODULE_8__.O,
    direction: 'y',
    threshold: 10,
    canStart,
    onStart,
...
const createSheetGesture = (baseEl, backdropEl, wrapperEl, initialBreakpoint, backdropBreakpoint, animation, breakpoints = [], getCurrentBreakpoint, onDismiss, onBreakpointChange) => {
  ...
  const enableBackdrop = () => {
     ...
     * the sheet.
     */
    baseEl.classList.remove(_overlays_2ea57630_js__WEBPACK_IMPORTED_MODULE_8__.F);
  };
  const disableBackdrop = () => {
     ...
     */
    baseEl.classList.add(_overlays_2ea57630_js__WEBPACK_IMPORTED_MODULE_8__.F);
  };
  /**
...
const Modal = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_4e02bb5d_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionModalDidPresent", 7);
    this.willPresent = (0,_index_4e02bb5d_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionModalWillPresent", 7);
    this.willDismiss = (0,_index_4e02bb5d_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionModalWillDismiss", 7);
    this.didDismiss = (0,_index_4e02bb5d_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionModalDidDismiss", 7);
    this.ionBreakpointDidChange = (0,_index_4e02bb5d_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionBreakpointDidChange", 7);
    ...
    this.ionMount = (0,_index_4e02bb5d_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionMount", 7);
    this.lockController = (0,_lock_controller_316928be_js__WEBPACK_IMPORTED_MODULE_5__.c)();
    this.triggerController = (0,_overlays_2ea57630_js__WEBPACK_IMPORTED_MODULE_8__.e)();
    ...
    this.onBackdropTap = () => {
      ...
      this.dismiss(undefined, _overlays_2ea57630_js__WEBPACK_IMPORTED_MODULE_8__.B);
    };
  ...
  connectedCallback() {
    ...
    (0,_overlays_2ea57630_js__WEBPACK_IMPORTED_MODULE_8__.j)(el);
    this.triggerChanged();
  }
  ...
  componentWillLoad() {
    ...
    if (!((_a = this.htmlAttributes) === null || _a === void 0 ? void 0 : _a.id)) {
      (0,_overlays_2ea57630_js__WEBPACK_IMPORTED_MODULE_8__.k)(this.el);
    }
  }
  componentDidLoad() {
    /**
  ...
  present() {
    ...
    return (0,_Users_user_Documents_Workspace_englishApp_englishAppFrontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if ((0,_helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_4__.k)(el)) {
        yield (0,_index_8579e7fd_js__WEBPACK_IMPORTED_MODULE_10__.e)(_this2.usersElement);
        /**
        ...
        yield (0,_index_8579e7fd_js__WEBPACK_IMPORTED_MODULE_10__.w)();
      }
      (0,_index_4e02bb5d_js__WEBPACK_IMPORTED_MODULE_1__.w)(() => _this2.el.classList.add('show-modal'));
       ...
       */
      if (hasCardModal && (0,_ionic_global_8f9440ec_js__WEBPACK_IMPORTED_MODULE_11__.b)(_this2) === 'ios') {
        // Cache the original status bar color before the modal is presented
        _this2.statusBarStyle = yield StatusBar.getStyle();
        setCardStatusBarDark();
      }
      yield (0,_overlays_2ea57630_js__WEBPACK_IMPORTED_MODULE_8__.f)(_this2, 'modalEnter', iosEnterAnimation, mdEnterAnimation, {
  ...
  initSwipeToClose() {
    var _this3 = this;
    var _a;
    if ((0,_ionic_global_8f9440ec_js__WEBPACK_IMPORTED_MODULE_11__.b)(this) !== 'ios') {
      return;
    }
    const {
      el
    ...
    const animationBuilder = this.leaveAnimation || _ionic_global_8f9440ec_js__WEBPACK_IMPORTED_MODULE_11__.c.get('modalLeave', iosLeaveAnimation);
    ...
    this.gesture = createSwipeToCloseGesture(el, ani, statusBarStyle, () => {
      ...
      this.animation.onFinish( /*#__PURE__*/(0,_Users_user_Documents_Workspace_englishApp_englishAppFrontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        yield _this3.dismiss(undefined, _overlays_2ea57630_js__WEBPACK_IMPORTED_MODULE_8__.G);
  ...
  initSheetGesture() {
    ...
    const animationBuilder = this.enterAnimation || _ionic_global_8f9440ec_js__WEBPACK_IMPORTED_MODULE_11__.c.get('modalEnter', iosEnterAnimation);
  ...
  sheetOnDismiss() {
    ...
    this.animation.onFinish( /*#__PURE__*/(0,_Users_user_Documents_Workspace_englishApp_englishAppFrontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield _this4.dismiss(undefined, _overlays_2ea57630_js__WEBPACK_IMPORTED_MODULE_8__.G);
  ...
  dismiss(data, role) {
    ...
    return (0,_Users_user_Documents_Workspace_englishApp_englishAppFrontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      var _a;
      if (_this5.gestureAnimationDismissing && role !== _overlays_2ea57630_js__WEBPACK_IMPORTED_MODULE_8__.G) {
        return false;
      }
      /**
       ...
       */
      const hasCardModal = presentingElement !== undefined;
      if (hasCardModal && (0,_ionic_global_8f9440ec_js__WEBPACK_IMPORTED_MODULE_11__.b)(_this5) === 'ios') {
      ...
      const dismissed = yield (0,_overlays_2ea57630_js__WEBPACK_IMPORTED_MODULE_8__.g)(_this5, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, {
        presentingEl: presentingElement,
      ...
      if (dismissed) {
        ...
        (0,_index_4e02bb5d_js__WEBPACK_IMPORTED_MODULE_1__.w)(() => _this5.el.classList.remove('show-modal'));
        if (_this5.animation) {
   ...
   */
  onDidDismiss() {
    return (0,_overlays_2ea57630_js__WEBPACK_IMPORTED_MODULE_8__.h)(this.el, 'ionModalDidDismiss');
  }
  /**
   * Returns a promise that resolves when the modal will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_2ea57630_js__WEBPACK_IMPORTED_MODULE_8__.h)(this.el, 'ionModalWillDismiss');
  }
  /**
  ...
  render() {
    ...
    const mode = (0,_ionic_global_8f9440ec_js__WEBPACK_IMPORTED_MODULE_11__.b)(this);
    ...
    return (0,_index_4e02bb5d_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_4e02bb5d_js__WEBPACK_IMPORTED_MODULE_1__.f, Object.assign({
      ...
      class: Object.assign({
        ...
        'overlay-hidden': true,
        [_overlays_2ea57630_js__WEBPACK_IMPORTED_MODULE_8__.F]: focusTrap === false
      ...
      part: "backdrop"
    }), mode === 'ios' && (0,_index_4e02bb5d_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: 'ce22e4caf1096e87248926fe2477f0d5a4c8a5cf',
      class: "modal-shadow"
    }), (0,_index_4e02bb5d_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", Object.assign({
    ...
    }), showHandle && (0,_index_4e02bb5d_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
